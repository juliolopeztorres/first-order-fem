...
from FirstOrderFemPyCode.Framework.Command.FrontierElementGroup.ViewObject import ViewObject
...
class ViewProvider(ViewProviderInterface, ViewInterface.CallbackInterface):
    ...
    def getIcon(self) -> str:
        return os.path.join(Util.getModulePath(), "assets", "icons", "nodes-elements-group.png")
