...
from FirstOrderFemPyCode.Framework.Command.FrontierElementsContainer.ViewObject import ViewObject
...
class ViewProvider(ViewProviderInterface, ViewInterface.CallbackInterface):
    ...
    def getIcon(self) -> str:
        return os.path.join(Util.getModulePath(), "assets", "icons", "frontier-elements-container.png")
