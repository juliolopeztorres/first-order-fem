...
from FirstOrderFemPyCode.Framework.Command.PrescribedNodesContainer.ViewObject import ViewObject
...
class ViewProvider(ViewProviderInterface, ViewInterface.CallbackInterface):
    ...
    def getIcon(self) -> str:
        return os.path.join(Util.getModulePath(), "assets", "icons", "prescribed-nodes-container.png")
